...
# 科学上网插件
git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall package/psw
...
sed -i "s/${orig_version}/R${date_version} by thungnoon/g" package/lean/default-settings/files/zzz-default-settings
